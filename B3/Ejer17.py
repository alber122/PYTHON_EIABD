...
# la semana. Para esto, se registran los días que trabajó y las horas de cada día. Realice un
...
# Cada día se puede trabajar 8h como maximo
dia=8
# Algoritmo con for
while empleado<=totaltrabajadores:
        horas_semana=int(input("¿Cuantas horas has trabajado esta semana, empleado?: "))
        dias_semana=abs(horas_semana//8)
        horas_semana_restante=float(horas_semana%8)
        print("El trabajador ha trabajado: ",dias_semana,"días y",horas_semana_restante,"horas , esta semana")
